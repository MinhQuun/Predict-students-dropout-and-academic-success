...
def member_page():
    st.title("👥 Thông tin nhóm và Nội dung thực hiện")

    st.markdown("""
    ### 🧑‍🎓 Thành viên thực hiện:

    1. **Võ Nguyễn Minh Quân**  \\
    📘 MSSV: 2001223952  \\
    📌 Vai trò: Phân tích kết quả, huấn luyện mô hình, trình bày ứng dụng.

    2. **Trần Minh Luân**  \\
    📘 MSSV: 2001222492  \\
    📌 Vai trò: Tiền xử lý dữ liệu, , trực quan hóa dữ liệu, viết báo cáo thống kê.

    3. **Trương Quang Như Đoan**  \\
    📘 MSSV: 2001220985  \\
    📌 Vai trò: Triển khai mô hình, xử lý bất cân bằng, xây dựng giao diện Streamlit.
    ...
    → Gồm dữ liệu đại học, phân loại sinh viên thành: Bỏ học – Đang học – Tốt nghiệp.
    ...
    - Khám phá phân tích chuyên sâu tại trang `Insight`.
    - Trực tiếp dự đoán và đánh giá hiệu quả mô hình học máy tại trang `Predict`.

    ---

    ### 🔗 Github dự án
    👉 [MinhQuun/Predict-students-dropout-and-academic-success](https://github.com/MinhQuun/Predict-students-dropout-and-academic-success)
